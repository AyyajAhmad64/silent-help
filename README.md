...
Seed data is enabled by default. Demo credentials may be configured in `DataSeeder` and `application.properties`; check the current local config before sharing them.
